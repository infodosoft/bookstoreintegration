...
public class MockUtils {
    ...
    public static void startServer() {
        MockServer server = MockServer.feature("classpath:Features/mock/mock.feature").build();
        System.setProperty("mock.cats.url", "http://localhost:" + server.getPort() + "/cats");        
    }

    private static final List<String> catNames = (List) Runner.runFeature("classpath:Features/mock/feeder.feature", null, false).get("names");
